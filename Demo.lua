...
ImageButton.Image = "http://www.roblox.com/asset/?id=75395704949328"
...
local Window = Fluent:CreateWindow({
    Title = "TKhang Roblox Tổng Hợp",
    SubTitle = "Blox Fruit",
    TabWidth = 157,
    Size = UDim2.fromOffset(555, 333),
    Acrylic = true,
    Theme = "Dark",
...
local Tabs = {
    ...
    Title = "Discord",
    Description = "TKhangRoblox Community",
    Callback = function()
